  ...
  return (
    <section className="relative py-28 md:py-36 overflow-hidden">
      <div className="absolute inset-0">
        ...
        />
        {/* Azul-Karilo overlay */}
        <div className="absolute inset-0 bg-gradient-to-r from-[#03051a]/92 via-[#020b3a]/80 to-[#050bfa]/30" />
      </div>
      ...
      <div className="relative z-10 container px-6">
        <div className="max-w-2xl">
          ...
          <p className="font-body text-white/65 text-lg mb-10 leading-relaxed max-w-xl">
